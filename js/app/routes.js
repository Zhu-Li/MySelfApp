...
App.registerRoutes = function() {
  Router.registerAll({
    ...
    '/book/novel/:bookId': (params) => this.renderNovelChapters(params.bookId),
    '/book/classics': () => this.renderClassicsBrowse(),
    '/book/classics/:bookId': (params) => this.renderClassicsReader(params.bookId),
    '/novel': () => this.renderBook(),
    '/novel/:bookId': (params) => this.renderNovelChapters(params.bookId),
